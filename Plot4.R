...
plot(sub_EP$DateTime, sub_EP$Voltage, type="l",xlab="datetime",ylab="Voltage")
plot(sub_EP$DateTime, sub_EP$Global_reactive_power, type="l",xlab="datetime",ylab="Global_reactive_power")
